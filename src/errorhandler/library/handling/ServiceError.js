sap.ui.define([
	...
	return BaseHandling.extend("errorhandler.library.handling.ServiceError", {
		...
		showError: function({
			...
			if (!this.getMessageModel().getData().some(msg => msg.message === oError.message)) {
			...
			const sText = appUseable ? oError.message : oError.message + " " + this.getResBundle().getText("navToLaunchpad");
