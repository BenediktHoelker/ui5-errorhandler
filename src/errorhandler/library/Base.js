sap.ui.define(
  ...
  function (Message, OpaPlugin, ResourceModel) {
    return {
      ...
      getFirstParentOfType(control, type) {
        const parent = control.getParent();
        if (!parent) return undefined;
        if (this.checkControlIsType(control, type)) return parent;
        return this.getFirstParentOfType(parent, type);
      },
      ...
      checkControlIsType(control, type) {
        return (
          control &&
      ...
      getMessagesOfSmartField(control) {
        const isSmartField = this.checkControlIsType(
          control,
